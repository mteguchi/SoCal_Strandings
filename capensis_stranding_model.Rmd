...
According to LOOIC, M2 is the best.
...
According to DIC, M2a is best.

```{r}
best.model <- jm.2
best.model.MCMC <- jm.2.MCMC
...
```{r}
mean.mean_N <- best.model$mean$mean_N
low.mean_N <- best.model$q2.5$mean_N
high.mean_N <- best.model$q97.5$mean_N
