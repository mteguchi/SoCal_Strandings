...
According to DIC, M4e is best. Looked at posterior statisitcs and f1 and f2 are identical... so, I'll go with M4c
...
```{r}
mcmc_dens(best.model$jm.out$samples, c("r", "f1", "f2", "mu",  "b", "mu1",  "p2"))
```
```{r}
