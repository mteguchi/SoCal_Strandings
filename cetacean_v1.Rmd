...
Can we count strandings per unit length of coast lines?
...
# first MB - convert polygon to line
...
# SDB includes a bit of Silver Strand in the North Island Air Station...
tmp <- st_intersection(SD.coast, SDB.line)
tmp2 <- st_difference(SD.coast, SDB.line)

SD.coast.no.MB <- st_difference(SD.coast, MB.poly)
