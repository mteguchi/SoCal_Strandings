...
coast.line <- getCoastLine("data/coast/coast_Epac.txt",
                           lon.limits = c(W.lon, E.lon),
                           lat.limits = c(S.lat, N.lat))
...
#ggsave(p2, filename = paste0("figures/StrandingLocations_", Y[k], ".png"),
#       device = "png", dpi = 600)  
#}
...
ggplot(data = dat.1) +
  ...
  geom_histogram(aes(x = Latitude), binwidth = 0.05) +
  facet_wrap("Month") +
